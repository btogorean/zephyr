...
typedef enum {
	...
	AUDIO_CHANNEL_HP_LEFT,
	AUDIO_CHANNEL_HP_RIGHT,
	AUDIO_CHANNEL_LINE_LEFT,
	AUDIO_CHANNEL_LINE_RIGHT,
	AUDIO_CHANNEL_MIC_LEFT,
	AUDIO_CHANNEL_MIC_RIGHT,
	AUDIO_CHANNEL_DIGITAL_LEFT,
	AUDIO_CHANNEL_DIGITAL_RIGHT,
	AUDIO_CHANNEL_MONOOUT,
	AUDIO_CHANNEL_ALL,
} audio_channel_t;

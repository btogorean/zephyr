...
#define ADAU1X61_ADC_CONTROL_ADCEN_LEFT_ADC	BIT(1)
#define ADAU1X61_ADC_CONTROL_ADCEN_RIGHT_ADC	BIT(2)

#define ADAU1X61_REC_MIXER_LEFT0_MIXER_EN	BIT(1)
#define ADAU1X61_REC_MIXER_RIGHT0_MIXER_EN	BIT(1)
